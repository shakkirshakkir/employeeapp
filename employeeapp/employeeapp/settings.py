...
SECRET_KEY = 'django-insecure-l3u)$3d_^1ypt%@h6=av$yugwocwqgb467*io*f8$eybqnk_xg'
...
AUTH_USER_MODEL = 'employee.CustomUser'  # Adjust this if your app name is different
